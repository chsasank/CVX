...
\bibitem{1} Wikipedia
\bibitem{2} Miguel Sousa Lobo, Maryam Fazel, Stephen BoydPortfolio , \textit{Optimization with linear and fixed transaction costs}, Springer Science + Business Media, LLC 2006
\end{thebibliography}
